...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._countSurvival_list = []  # list to store whether pt survives over five years
    ...
    def get_count_survival_list(self):
        """:returns the list of 0 and 1 whether the patients survive over five years"""
        return  self._countSurvival_list
...
class CohortOutcomes:
    def __init__(self, simulated_cohort):
        ...
        self._sumStat_fiveYearSurvival = \
            Stat.SummaryStat('Five year survivals', self._simulatedCohort.get_count_survival_list())
    ...
    def get_prob_five_year_survival(self):
        return self._sumStat_fiveYearSurvival.get_mean()

    def get_CI_prob_five_year_survival(self,alpha):
        return self._sumStat_fiveYearSurvival.get_t_CI(alpha)
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._fiveYearSurvivals = []   # two dimensional list of five year survival indices from each simulated cohort
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store all five year survival indices from this cohort
            self._fiveYearSurvivals.append(cohort.get_count_survival_list())
            # store probability of five year survival for this cohort
            self._probFiveYearSurvivals.append(output.get_prob_five_year_survival())
        ...
        # summary statistics of probability of five year survival
        self._sumStat_probFiveYearSurvival = Stat.SummaryStat('Five year survival', self._probFiveYearSurvivals)

    # Cohort specific stats
    def get_cohort_mean_survival(self, cohort_index):
        """ returns the mean survival time of a specified cohort
    ...
    def get_cohort_CI_prob_five_year_survival(self, cohort_index, alpha):
        """ :returns the confidence interval of the probability of five year survival for a specified cohort"""
        st2 = Stat.SummaryStat('', self._fiveYearSurvivals[cohort_index])
    ...
    def get_all_five_year_prob(self):
        ...
        return self._probFiveYearSurvivals
    ...
    def get_overall_five_year_prob(self):
        ...
        return self._sumStat_probFiveYearSurvival.get_mean()
    ...
    def get_cohort_PI_five_year_prob(self, cohort_index, alpha):
        st3 = Stat.SummaryStat('', self._probFiveYearSurvivals[cohort_index])
        return st3.get_PI(alpha)

    def get_PI_five_year_prob(self,alpha):
        return self._sumStat_probFiveYearSurvival.get_PI(alpha)
